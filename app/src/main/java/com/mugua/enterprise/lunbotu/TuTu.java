package com.mugua.enterprise.lunbotu;
...
public class TuTu implements MyAdapter.OnItemClickListener {
	...
	private int kind;
	public TuTu(ViewPager mViewPager, TextView mTextView, LinearLayout mLinearLayout, Context mContext, List<ADBean> listADbeans, int kind) {
	...
	private void initADViewpager() {
		for(int i = 0; i < listADbeans.size(); i++){
			...
			params = new LayoutParams(dip2px(mContext,10), dip2px(mContext,10));
...
//		CustomToast.showToast(mContext,position+"",1000);
