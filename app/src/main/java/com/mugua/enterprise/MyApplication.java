...
import com.mugua.jiguang.chat.entity.NotificationClickEventReceiver;
import com.mugua.jiguang.chat.location.service.LocationService;
import com.mugua.jiguang.chat.pickerimage.utils.StorageUtil;
import com.mugua.jiguang.chat.utils.SharePreferenceManager;
import com.mugua.jiguang.chat.utils.imagepicker.GlideImageLoader;
import com.mugua.jiguang.chat.utils.imagepicker.ImagePicker;
import com.mugua.jiguang.chat.utils.imagepicker.view.CropImageView;
...
public class MyApplication extends com.activeandroid.app.Application {
    ...
    {
        //微信
        PlatformConfig.setWeixin("wx65b6dabc5d020744", "352f2e89b908c576b5d6af79b0fae9dd");
        //新浪微博(第三个参数为回调地址)
        PlatformConfig.setSinaWeibo("1850714751", "273601d8a10784e872488f724e0c080d","http://sns.whalecloud.com/sina2/callback");
        //QQ
        PlatformConfig.setQQZone("1106467599", "KEYY9xgvlhPJ6N9r4nR");
    }
