...
public class YinDaoActivity extends AutoLayoutActivity implements View.OnClickListener{
...
//        mIn_vp.setPageTransformer(true,new DepthPageTransformer());
    ...
    private void addDots() {
        ...
        mfrom_dot = new ImageView(this);
        mfrom_dot.setImageResource(R.drawable.gray_dot);
        mIn_ll.addView(mfrom_dot, layoutParams);
        setClickListener();
    ...
    private void setClickListener() {
        ...
        mfrom_dot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            case R.id.bt_next:
                ...
                LocalUserInfo.getInstance(YinDaoActivity.this).setUserInfo("open2", "true");
                finish();
                break;
        }
    }
