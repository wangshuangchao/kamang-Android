...
public class DetailListPlayer extends GSYBaseActivityDetail {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urls.add(new GSYVideoModel("http://123.56.5.178:8888/group1/M00/00/00/rBGp8FobwtmAT1bfAFpKsXmDqCg018.mp4", "标题1"));
        urls.add(new GSYVideoModel("http://9890.vod.myqcloud.com/9890_4e292f9a3dd011e6b4078980237cc3d3.f20.mp4", "标题2"));
        urls.add(new GSYVideoModel("http://123.56.5.178:8888/group1/M00/00/00/rBGp8FobwtmAT1bfAFpKsXmDqCg018.mp4", "标题3"));
