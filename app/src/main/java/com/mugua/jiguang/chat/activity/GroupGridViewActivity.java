...
import com.mugua.jiguang.chat.adapter.GroupGridViewAdapter;
    ...
    private void initData() {
        ...
        mGroup_gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position < mCurrentNum) {
                    ...
                    startActivityForResult(intent, MyApplication.REQUEST_CODE_ALL_MEMBER);
                }
            }
        });
        ...
        mSearch_title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyApplication.mSearchGroup = mMemberInfoList;
                startActivity(intent);
            }
        });
