package com.mugua.jiguang.chat.adapter;
...
import com.mugua.jiguang.chat.activity.SearchFriendDetailActivity;
...
import com.mugua.jiguang.chat.utils.BitmapLoader;
import com.mugua.jiguang.chat.utils.DialogCreator;
import com.mugua.jiguang.chat.utils.NativeImageLoader;
import com.mugua.jiguang.chat.utils.SharePreferenceManager;
import com.mugua.jiguang.chat.utils.ViewHolder;
import com.mugua.jiguang.chat.utils.photochoose.SelectableRoundedImageView;
import com.mugua.jiguang.chat.view.SwipeLayout;
            ...
            public void gotResult(int i, String s, UserInfo userInfo) {
                if (i == 0) {
                    if (userInfo.isFriend()) {
                        ...
                        item.save();
                        FriendEntry entry = FriendEntry.getFriend(MyApplication.getUserEntry(), item.username, item.appKey);
                        if (entry == null) {
