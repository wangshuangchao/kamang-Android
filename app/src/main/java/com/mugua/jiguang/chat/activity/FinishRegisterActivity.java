...
import com.mugua.jiguang.chat.utils.photochoose.ChoosePhoto;
import com.mugua.jiguang.chat.utils.photochoose.PhotoUtils;
                ...
                case R.id.finish_btn:
                    ...
                    JMessageClient.login(userId, password, new BasicCallback() {
                        ...
                        public void gotResult(int responseCode, String responseMessage) {
                            if (responseCode == 0) {
                                MyApplication.registerOrLogin = 1;
                                ...
                                JMessageClient.updateMyInfo(UserInfo.Field.nickname, myUserInfo, new BasicCallback() {
                                    ...
                                    public void gotResult(final int status, String desc) {
                                        ...
                                        mDialog.dismiss();
                                        if (status == 0) {
                                            goToActivity(FinishRegisterActivity.this, XiaoXiActivity.class);
                                        }
                                    }
                                });
                                //注册时更新头像
