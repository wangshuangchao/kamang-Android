...
import com.mugua.jiguang.chat.activity.ChatDetailActivity;
import com.mugua.jiguang.chat.activity.FriendInfoActivity;
import com.mugua.jiguang.chat.activity.GroupAvatarActivity;
import com.mugua.jiguang.chat.activity.GroupGridViewActivity;
import com.mugua.jiguang.chat.activity.GroupNotFriendActivity;
import com.mugua.jiguang.chat.activity.MembersInChatActivity;
import com.mugua.jiguang.chat.activity.PersonalActivity;
import com.mugua.jiguang.chat.activity.VerificationActivity;
import com.mugua.jiguang.chat.activity.historyfile.activity.HistoryFileActivity;
...
import com.mugua.jiguang.chat.database.FriendEntry;
...
import com.mugua.jiguang.chat.view.ChatDetailView;
import com.mugua.jiguang.chat.view.SlipButton;
...
public class ChatDetailController implements OnClickListener, OnItemClickListener,
            ...
            mUserInfo.removeFromFriendList(new BasicCallback() {
                ...
                public void gotResult(int responseCode, String responseMessage) {
                    ...
                    if (responseCode == 0) {
                        ...
                        MyApplication.forAddFriend.remove(mUserInfo.getUserName());
                        //将好友删除时候还原黑名单设置
                        List<String> name = new ArrayList<>();
                        name.add(mUserInfo.getUserName());
                        JMessageClient.delUsersFromBlacklist(name, null);

                        FriendEntry friend = FriendEntry.getFriend(MyApplication.getUserEntry(),
    ...
    public void delConvAndReturnMainActivity() {
        ...
        Intent intent = new Intent(mContext, XiaoXiActivity.class);
        mContext.startActivity(intent);
    }
