package com.mugua.jiguang.chat.location.activity;
...
import com.mugua.jiguang.chat.location.adapter.MapPickerAdapter;
import com.mugua.jiguang.chat.location.service.LocationService;
import com.mugua.jiguang.chat.utils.BitmapLoader;

import static com.mugua.enterprise.MyApplication.context;
...
public class MapPickerActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String targetId = getIntent().getStringExtra(MyApplication.TARGET_ID);
        String targetAppKey = getIntent().getStringExtra(MyApplication.TARGET_APP_KEY);
