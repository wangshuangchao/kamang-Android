...
public class SearchAtMemberActivity extends BaseActivity implements View.OnClickListener {
    ...
    private SearchResult filterInfo(String filterStr) {
        ...
        //所有好友名单
        for (UserInfo friendInfo : MyApplication.mSearchAtMember) {
        ...
        mLv_searchGroup.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (itemAtPosition instanceof UserInfo) {
                    ...
                    intent.putExtra(MyApplication.SEARCH_AT_MEMBER_NAME, atName);
                    intent.putExtra(MyApplication.SEARCH_AT_MEMBER_USERNAME, userInfo.getUserName());
                    intent.putExtra(MyApplication.SEARCH_AT_APPKEY, userInfo.getAppKey());
                    setResult(MyApplication.SEARCH_AT_MEMBER_CODE, intent);
                    finish();
                }
            }
        });
